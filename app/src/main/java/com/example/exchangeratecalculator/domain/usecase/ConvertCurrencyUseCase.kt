...
class ConvertCurrencyUseCase
    ...
    constructor() {
        ...
        private fun parseAmount(inputText: String): BigDecimal = inputText.toBigDecimalOrZero().coerceAtLeast(BigDecimal.ZERO)
        ...
        private fun convertAmount(
            ...
            val convertedAmount =
                if (fromCode == USDC_CURRENCY.code) {
        ...
        private fun displayAmount(amount: BigDecimal): BigDecimal = amount.scaleForDisplay(DISPLAY_SCALE)
